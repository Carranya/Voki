...
$modulliste = array(
    ...
    echo "<div class='left'>";
        ...
        $link_left = "voki.php?page=abfrage";
    ...
    echo "<div class='content'>";
        ...
        if(isset($_POST['modul']))
        {
            ...
            if($_GET['page'] == 'abfrage')
            {
                ...
                echo "<form action='voki.php?page=abfrage' method='post'>";
        ...
        else
        {
            ...
            <br>
            <br>
            <i>Last Update: 12.08.2022 - Version 1.01<br>
            - Neue UI<br>
            - Wörterpaket \"Japanisch Adjektive Level 1\" hinzugefügt.</i>
            </p>";
        }
    ...
    echo "<div class='right'>";
        ...
        $link_right = "voki.php?page=anzeige";
        $menu_right = new Menuliste($sprachliste, $modulliste, $link_right);
    echo "</div>";
echo "</div>";
echo "<div class='foot'>";
    echo "<p>Version 1.01<br><a href='mailto:karin.giang1982@gmail.com'>Karin Giang</a></p>";
echo "</div>";
