...
<body>
    <h1>Vokabular Training Japanisch</h1>
    <form action="vokijap.php" method="post">
    ...
    <?php
        ...
        $anzahl = $con->query("SELECT COUNT(1) FROM japanisch");
        ...
        $id = random_int(1,$max);
        $lang = random_int(1,2);
        $sql = "SELECT * FROM japanisch WHERE id='$id'";
        $res = $con->query($sql);
